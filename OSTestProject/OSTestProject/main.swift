...
/*
 今天: Optional(1479484800.0)
 标准时间: 2016-11-18 16:00:00 +0000
 */

let calendar = CalendarInfo()
print(calendar.calendar.timeZone)
let date = Date(timeIntervalSince1970: 1479484800)
let cal2 = CalendarInfo(date: date)
print(cal2.day)

let day = calendar.firstTimeInDay()!
print(day)
